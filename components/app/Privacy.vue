  ...
  <div class="privacy-wrapper">
    <div class="content-privacy">
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта компании Фабрина, ИП
        Зотеев Виктор Анатольевич, ИНН 165206828302
      </p>
      ...
      <p>
        ...
        почты с доменом Man741@inbox.ru с пометкой «Отказ от уведомлений о новых
